...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "requires_nvim: mark test as requiring Neovim")
    config.addinivalue_line("markers", "requires_jupyter: mark test as requiring Jupyter")
